...
export const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    notificationTypes: {
      ...
      settingsSavedMessage: 'Your preferences have been updated successfully',
  ...
  ru: {
    ...
    dashboard: {
      ...
      criticalIncidents: 'Критические инциденты и инциденты высокой важности',
    ...
    alerts: {
      ...
      manageRules: 'Управление правилами обнаружения и настройками уведомлений',
  ...
  tk: {
    ...
    alerts: {
      ...
      manageRules: 'Ýüze çykaryş düzgünlerini we habarnamalary dolandyryň',
